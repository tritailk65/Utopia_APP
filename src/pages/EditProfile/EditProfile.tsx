        ...
        <div className="ml-[200px] mt-[100px]">
            <div className="mb-4">
                <div className="flex items-center space-x-4">
                    <div className="h-12 w-12 rounded-full overflow-hidden">
                        <img src={hinhdaidien} className="object-cover w-full h-full"/>
                    </div>
                    <div className="">
                        <h1 className="ml-5">hello</h1>
                        <a href="/" className="text-blue-600 hover:underline ml-5" onClick={handleLinkClick}>Change Profile Photo</a>
                        <input
                            type="file"
                            accept="image/*"
                            ref={fileInputRef}
                        ...
                        />
                        {selectedFileName && (
                        <p className="ml-[20px]">Selected file: {selectedFileName}</p>
                        )}
                    </div>
           ...
           <div className="space-y-10">
                                ...
                                <div className="flex space-x-2">
                                    <label htmlFor="website" className="block text-[20px] font-bold">Website</label>
                                    <input 
                                    type="text" 
                                    id="website" 
                                    name="website" 
                                ...
                                <div className="flex space-x-[42px]">
                                        <label htmlFor="blog" className="block text-[20px] font-bold">Blog</label>
                                        <input 
                                        type="text" 
                                        id="blog" 
                                        name="blog" 
                                ...
                                <div className="flex space-x-4">
                                    <label htmlFor="gender" className="block text-[20px] font-bold">Gender</label>
                                    <select 
                                    id="gender" 
                                    name="gender" 
                                    className="w-[350px] rounded-md border-gray-900 shadow-sm border-2"
