        ...
        if (check) {
            return (
                <div className="fixed inset-0 flex items-center justify-center z-50">
                    ...
                    <div className="modal-content relative bg-white p-4 rounded-lg shadow-lg z-50 w-[400px]">
                        <div className="flex space-x-3 mt-2">
                            ...
                            <div className="mt-[15px] w-full">
                                ...
                                <button
                                    onClick={onClose}
                                    className="mt-4 ml-[100px] bg-green-500 text-white px-3 py-1 rounded hover:bg-green-600 float-right mr-2"
                                >
                                    Đóng
                                </button>
                            </div>
                    ...
                    <div className="modal-content relative bg-white p-4 rounded-lg shadow-lg z-50 w-[400px]">
                        <div className="flex space-x-3 mt-2">
                            ...
                            <div className="mt-[15px]">
                                ...
                                <button
                                    onClick={onClose}
                                    className="mt-4 ml-[100px] bg-red-500 text-white px-3 py-1 rounded hover:bg-red-600 float-right mr-2"
                                >
                                    Đóng
                                </button>
                            </div>
